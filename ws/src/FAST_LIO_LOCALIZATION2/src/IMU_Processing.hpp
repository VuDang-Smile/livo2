...
#define MAX_INI_COUNT (100)  // Increased from 20 to 100 for better IMU initialization when device is tilted
...
void ImuProcess::IMU_init(const MeasureGroup &meas, esekfom::esekf<state_ikfom, 12, input_ikfom> &kf_state, int &N)
{
  ...
  init_P.setIdentity();
  init_P(6,6) = init_P(7,7) = init_P(8,8) = 0.001;  // Increased from 0.00001 to 0.001 for rotation uncertainty
