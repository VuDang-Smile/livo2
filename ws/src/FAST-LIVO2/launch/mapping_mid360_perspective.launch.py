...
def generate_launch_description():
    ...
    #Load parameters
    mid360_config_cmd = os.path.join(config_file_dir, "mid360_perspective.yaml")
    camera_config_cmd = os.path.join(config_file_dir, "camera_perspective.yaml")
    ...
    return LaunchDescription([
        ...
        # Lưu ý: Không cần node republish vì đã có sẵn /image_perspective topic
        # Các topic cần có sẵn:
        # - /livox/lidar (CustomMsg) - từ Livox MID360 driver
        # - /livox/imu - từ Livox MID360 driver
        # - /image_perspective - từ theta_driver perspective converter
